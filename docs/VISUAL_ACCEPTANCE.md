...
| Scale-aware spaced hamlets       | Exactly 2–4 primary settlement groups have internal structure and distinct identities. Expansive/vast repositories may add up to two subordinate satellite settlements. Terrain and clear negative space separate them; routes connect rather than merge them. | One dense clump, a continuous suburb, more than four visually equal clusters, evenly spaced lone houses, or buildings that overlap each other.                                                   |
