...
<p align="center">
  <a href="https://github.com/parrisdigital/repo-magical-kingdom/actions/workflows/ci.yml"><picture><source media="(prefers-color-scheme: dark)" srcset="https://shieldcn.dev/group/github/ci/parrisdigital/repo-magical-kingdom+github/stars/parrisdigital/repo-magical-kingdom+github/license/parrisdigital/repo-magical-kingdom+github/contributors/parrisdigital/repo-magical-kingdom+github/last-commit/parrisdigital/repo-magical-kingdom.svg?workflow=ci.yml&amp;branch=main&amp;variant=outline&amp;size=sm&amp;font=geist&amp;animate=glow&amp;mode=dark" /><img alt="CI passing, GitHub stars, MIT license, contributors, and latest commit" src="https://shieldcn.dev/group/github/ci/parrisdigital/repo-magical-kingdom+github/stars/parrisdigital/repo-magical-kingdom+github/license/parrisdigital/repo-magical-kingdom+github/contributors/parrisdigital/repo-magical-kingdom+github/last-commit/parrisdigital/repo-magical-kingdom.svg?workflow=ci.yml&amp;branch=main&amp;variant=outline&amp;size=sm&amp;font=geist&amp;animate=glow&amp;mode=light" /></picture></a>
</p>
